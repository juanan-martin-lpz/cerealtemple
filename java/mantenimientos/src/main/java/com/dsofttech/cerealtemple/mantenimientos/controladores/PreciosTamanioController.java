...
import com.dsofttech.cerealtemple.mantenimientos.servicios.IPrecioTamanioService;

import lombok.extern.slf4j.Slf4j;

@Slf4j
@RestController
@RequestMapping("/preciostamanios")
public class PreciosTamanioController {

	@Autowired
	private IPrecioTamanioService servicio;
	...
	private ResponseEntity<?> _obtenerById(Long id) {
		...
		Optional<PrecioTamanio> precio = null;
